...
export default async function Page() {
    ...
    return ( 
        <Main header={
            ...
            <div className=" px-0 ">
                <h3 className="text-base/7 font-semibold text-gray-900 my-4">Mi información</h3> 
            ...
            <dl className="divide-y divide-gray-100">
                    <DescriptionItem label='Nombre completo' value={options.firstName+` `+options.lastName}></DescriptionItem>
                    <DescriptionItem label='Nombre de usuario' value={options.userName}></DescriptionItem>
